...
<div class="container-fluid">
   ...
   <div> {{--  class="col-lg-8" --}}
      <form method="post" action="/dashboard/code/" class="col-lg-8">
         @csrf
         ...
         <div class="form-group">
            ...
            <div class="d-flex" style="gap: 1em">
               <input type="url" class="form-control @error('thumbnail') is-invalid @enderror" id="thumbnail" name="thumbnail" value="{{ old('thumbnail') }}" autofocus>
         ...
         <div class="row">
            <div class="form-group col-lg-6">
               ...
               <input type="url" class="form-control @error('link1') is-invalid @enderror" id="link1" name="link1" placeholder="https://" value="{{ old('link1') }}">
            ...
            <div class="form-group col-lg-6">
               ...
               <input type="url" class="form-control @error('link2') is-invalid @enderror" id="link2" name="link2" placeholder="https://" value="{{ old('link2') }}">
         ...
         <div class="form-group">
            ...
            <textarea name="excerpt" name="excerpt" id="excerpt" cols="200" class="form-control @error('excerpt') is-invalid @enderror" style="min-height: 12em" maxlength="155" required>{{ old('excerpt') }}</textarea>
         </div>
