...
<div class="container-fluid">
   <h1>Edit Discovery</h1>
   <div class="dropdown-divider"></div>
   <div> {{--  class="col-lg-8" --}}
      <form method="post" action="/dashboard/discover/{{ $post->slug }}">
         @method('put')
         @csrf
         <div class="row">
         ...
         <div class="row">
            ...
            <div class="form-group col-lg-4">
               ...
               <input type="url" class="form-control @error('link') is-invalid @enderror" id="link" name="link" placeholder="https://" value="{{ old('link',$post->link) }}" required>
         ...
         <div class="row">
            <div class="form-group col-lg-4">
               ...
               <input type="url" class="form-control @error('cover') is-invalid @enderror" id="cover" name="cover" value="{{ old('cover',$post->cover) }}" placeholder="https://drive.google.com/file">
            ...
            <div class="form-group col-lg-4">
               ...
               <input type="url" class="form-control @error('thumbnail') is-invalid @enderror" id="thumbnail" name="thumbnail" placeholder="https://drive.google.com/file" value="{{ old('thumbnail',$post->thumbnail) }}">
            ...
            <div class="form-group col-lg-4">
               ...
               <input type="text" class="form-control" id="banner" name="banner" placeholder="https://drive.google.com/file" value="{{ old('banner',$post->banner) }}">
            </div>
         </div>
         <div class="row">
            <div class="form-group col-lg-8">
            ...
            <div class="form-group col-lg-4">
               ...
               <textarea cols="30" class="form-control @error('tag') is-invalid @enderror" id="tag" name="tag" placeholder="Separate tags with commas" style="min-height: 9em;">{{ old('tag',$post->tag) }}</textarea>
